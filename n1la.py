...
C1 =M[1]
x2 = (C1[4] - x1*C1[0] - xInicial[2]*C1[2] - xInicial[3]*C1[3])/C1[1]

print(x2)

C2 =M[2]
x3 = (C2[4] - x1*C2[0] - x2*C2[1] - xInicial[3]*C2[3])/C2[2]

print(x3)

C3 =M[3]
x4 = (C3[4] - x1*C3[0] - x2*C3[1] - x3*C3[2])/C3[3]
...
while(mr > precisao):
    i = i + 1
    x1 = (C0[4] - x2*C0[1] - x3*C0[2] - x4*C0[3])/C0[0]
    
    x2 = (C1[4] - x1*C1[0] - x3*C1[2] - x4*C1[3])/C1[1]

    x3 = (C2[4] - x1*C2[0] - x2*C2[1] - x4*C2[3])/C2[2]
